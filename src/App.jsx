			...
			>
				...
				<div>
					<span className="font-medium">
						รอบแรกทุกคนจะได้คืนคนละ 15,000 บาทก่อน เมื่อครบ 13 คน แล้วจะวนกลับมาเริ่มใหม่
						ทั้งนี้ในรอบแรกขอแบ่งของแต่ละคนเป็นคนละ 30 งวด เพื่อให้ง่ายต่อการ Tracking
					</span>
				</div>
			</div>

			<div
				className="flex p-4 mb-4 text-sm text-yellow-600 rounded-xl bg-yellow-100 border border-yellow-500"
				role="alert"
			>
				<svg
					className="w-4 h-4 me-2 shrink-0"
